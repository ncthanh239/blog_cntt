...
<head>
  <meta charset="utf-8">
  <title>Uneti Blog IT | Chia sẻ kiến thức CNTT</title>
  <!-- Stylesheets -->
        ...
        <ul>
          ...
          <li data-description="Slide Description" data-easein="default" data-easeout="default" data-fsmasterspeed="1500" data-fsslotamount="7" data-fstransition="fade" data-hideafterloop="0" data-hideslideonmobile="off" data-index="rs-1687" data-masterspeed="default" data-param1="" data-param10="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-rotate="0" data-saveperformance="off" data-slotamount="default" data-thumb="images/main-slider/image-1.jpg" data-title="Slide Title" data-transition="parallaxvertical">
            ...
            <div class="slider-content">
              <h2>Find your latest news <br> with newspoint!</h2>
              ...
              <a href="#" class="theme-btn btn-style-two">our blog</a>
            </div>
          </div>
...
<div class="sidebar-page-container">
        ...
        <div class="category-tabs-box">
          ...
          <div class="prod-tabs tabs-box">
            ...
            <div class="tab-btns tab-buttons clearfix">
              <div class="pull-left">
                <div class="category">New Posts</div>
              </div>
              <div class="pull-right">
                ...
                <div class="content">
                    ...
                    <div class="column col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="single-item-carousel owl-carousel owl-theme">
                       ...
                       <div class="news-block-two">
                        <div class="inner-box">
                          <div class="image">
                            <a href="{{asset('')}}/{{$value['slug']}}"><img src="{{asset(\Storage::url($value['img']->first()['link_img']))}}" alt="" /></a>
                            <div class="category"><a href="{{asset('')}}{{$value['slug']}}">{{$value['category']->first()['name']}}</a></div>
                          </div>
                          <div class="lower-box">
                            <h3><a href="{{asset('')}}{{$value['slug']}}">{{$value['title']}}</a></h3>
                            <ul class="post-meta">
                              <li><span class="icon fa fa-clock-o"></span>{{$value['updated_at']}}</li>
                  ...
                  <div class="column col-md-6 col-sm-6 col-xs-12">
                    ...
                    <article class="widget-post">
                      ...
                      <figure class="post-thumb"><a href="{{asset('')}}{{$value['slug']}}"><img src="{{asset(\Storage::url($value['img']->first()['link_img']))}}" alt=""></a><div class="overlay"><span class="icon qb-play-arrow"></span></div></figure>
      ...
      <div class="category-tabs-box">
        ...
        <div class="prod-tabs tabs-box">
          ...
          <div class="tab-btns tab-buttons clearfix">
            ...
            <div class="pull-right">
              <div>
                <div data-tab="#economy-all" class="tab-btn active-btn">All</div>
          ...
          <div class="tabs-content">
                ...
                <div class="row clearfix">
                  ...
                  <div class="column col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="news-block-two with-margin">
                      <div class="inner-box">
                        <div class="image">
                          <a href="{{asset('')}}{{$value['slug']}}"><img src="{{asset(\Storage::url($value['img']->first()['link_img']))}}" alt="" /></a>
                          <div class="category"><a href="#">{{$value['category']->first()['name']}}</a></div>
                        </div>
                        <div class="lower-box">
                          <h3><a href="{{asset('')}}{{$value['slug']}}">{{$value['title']}}</a></h3>
                          <ul class="post-meta">
                  ...
                  @endforeach
                   ...
                   <div class="styled-pagination">
                      <ul class="clearfix">
                        <li><a class="next" href="#"><span class="fa fa-angle-left"></span></a></li>
            ...
            <!--Tab-->
            <div class="tab" id="economy-design">
              <div class="content">
                <div class="row clearfix">
                  <div class="column col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="news-block-two with-margin">
                      <div class="inner-box">
                        ...
                        <div class="lower-box">
                          <h3><a href="#">A great personality in the world, What he use for his personality ?</a></h3>
                          <ul class="post-meta">
                            <li><span class="icon fa fa-clock-o"></span>March 27, 2017</li>
                    ...
                    <article class="widget-post">
                      ...
                      <div class="text"><a href="blog-single.html">New York state and california are also close to cracking</a></div>
                  ...
                  <div class="column col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="news-block-two with-margin">
                      <div class="inner-box">
                        ...
                        <div class="lower-box">
                          ...
                          <ul class="post-meta">
                            <li><span class="icon fa fa-clock-o"></span>March 26, 2017</li>
                            <li><span class="icon fa fa-comment-o"></span>3</li>
                            <li><span class="icon fa fa-eye"></span>7420</li>
                          </ul>
                          <div class="text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit doli. Aenean commodo ligula eget dolor. Aenean massa. Cumtipsu sociis natoque penatibus et magnis dis montesti, nascetur ridiculus mus. Donec quam…</div>
                    ...
                    <article class="widget-post">
                      ...
                      <div class="text"><a href="blog-single.html">Six of the displaced Food filed a lawsuit against</a></div>
            ...
            <!--Tab-->
            <div class="tab" id="economy-fashion">
              <div class="content">
                <div class="row clearfix">
                  <div class="column col-md-6 col-sm-6 col-xs-12">
            ...
            <!--Tab-->
            <div class="tab" id="economy-sports">
              <div class="content">
                <div class="row clearfix">
                  <div class="column col-md-6 col-sm-6 col-xs-12">
            ...
            <!--Tab-->
            <div class="tab" id="economy-money">
              <div class="content">
                <div class="row clearfix">
                  <div class="column col-md-6 col-sm-6 col-xs-12">
  ...
  <!--Fullwidth Add-->
           {{--  <div class="fullwidth-add text-center">
              <div class="image">
                  <a href="#"><img src="images/resource/add-1.jpg" alt="" /></a>
                </div>
              </div> --}}
                    ...
                    <div class="image">
                      ...
                      <div class="overlay-box">
                        ...
                        <div class="content">
                          ...
                          <h3><a href="blog-single.html">Develop a new Silk Road through Russia</a></h3>
                          <ul class="post-meta">
                            <li><span class="icon qb-clock"></span>March 03, 2017</li>
                  ...
                  <div class="inner-box">
                    <div class="image">
                      ...
                      <div class="overlay-box">
                        <a href="blog-single.html" class="play-btn"><span class="icon qb-play-arrow"></span></a>
                        <div class="content">
                          <div class="tag"><a href="blog-single.html">Sports</a></div>
                          <h3><a href="blog-single.html">Does the festival have popular Design support</a></h3>
                          <ul class="post-meta">
                            <li><span class="icon qb-clock"></span>March 04, 2017</li>
                    ...
                    <div class="image">
                      ...
                      <div class="overlay-box">
                        ...
                        <div class="content">
                          ...
                          <h3><a href="blog-single.html">What is the festival about happens </a></h3>
                          <ul class="post-meta">
                            <li><span class="icon qb-clock"></span>March 05, 2017</li>
                        ...
                        <div class="row clearfix">
                          ...
                          <div class="content-box col-md-6 col-sm-6 col-xs-12">
                            <div class="content-inner">
                              <div class="category"><a href="blog-single.html">{{$value['category']->first()['name']}}</a></div>
                              <h3><a href="{{asset('')}}{{$value['slug']}}">{{$value['title']}}</a></h3>
                              <ul class="post-meta">
                                <li><span class="icon fa fa-clock-o"></span>{{$value['updated_at']}}</li>
                                <li><span class="icon fa fa-comment-o"></span>9</li>
                  ...
                  <aside class="sidebar default-sidebar">
                    ...
                    <div class="sidebar-widget facebook-widget">
                      ...
                      <div class="widget-content">
                        <div class="image">
                          <img src="images/resource/facebook-like.jpg" alt="" />
                        </div>
                      </div>
                    </div>
          ...
          <div class="instagram-gallery">
            <div class="gallery-outer clearfix">
              ...
              <div class="default-portfolio-item">
                <div class="inner-box">
                  <figure class="image-box"><img src="images/gallery/instagram-1.jpg" alt=""></figure>
                  <!--Overlay Box-->
                  <div class="overlay-box">
                    <div class="overlay-inner">
                      <div class="content">
                        <a href="images/gallery/instagram-1.jpg" data-fancybox="images" data-caption="" class="lightbox-image option-btn" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-search"></span></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="default-portfolio-item">
                <div class="inner-box">
                  <figure class="image-box"><img src="images/gallery/instagram-2.jpg" alt=""></figure>
                  <!--Overlay Box-->
                  <div class="overlay-box">
                    <div class="overlay-inner">
                      <div class="content">
                        <a href="images/gallery/instagram-2.jpg" data-fancybox="images" data-caption="" class="lightbox-image option-btn" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-search"></span></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="default-portfolio-item">
                <div class="inner-box">
                  <figure class="image-box"><img src="images/gallery/instagram-3.jpg" alt=""></figure>
                  <!--Overlay Box-->
                  <div class="overlay-box">
                    <div class="overlay-inner">
                      <div class="content">
                        <a href="images/gallery/instagram-3.jpg" data-fancybox="images" data-caption="" class="lightbox-image option-btn" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-search"></span></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="default-portfolio-item">
                <div class="inner-box">
                  <figure class="image-box"><img src="images/gallery/instagram-4.jpg" alt=""></figure>
                  <!--Overlay Box-->
                  <div class="overlay-box">
                    <div class="overlay-inner">
                      <div class="content">
                        <a href="images/gallery/instagram-4.jpg" data-fancybox="images" data-caption="" class="lightbox-image option-btn" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-search"></span></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="default-portfolio-item">
                <div class="inner-box">
                  <figure class="image-box"><img src="images/gallery/instagram-5.jpg" alt=""></figure>
                  <!--Overlay Box-->
                  <div class="overlay-box">
                    <div class="overlay-inner">
                      <div class="content">
                        <a href="images/gallery/instagram-5.jpg" data-fancybox="images" data-caption="" class="lightbox-image option-btn" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-search"></span></a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row clearfix">
                  ...
                  <div class="widget-column col-md-4 col-sm-6 col-xs-12">
                    <div class="footer-widget isntagram-widget">
                      ...
                      <div class="clearfix">
                        <figure class="image"><a href="images/resource/news-1.jpg" class="lightbox-image"  data-fancybox="images" data-caption=""><img src="images/resource/instagram-1.jpg" alt=""></a></figure>
                        <figure class="image"><a href="images/resource/news-2.jpg" class="lightbox-image"  data-fancybox="images" data-caption=""><img src="images/resource/instagram-2.jpg" alt=""></a></figure>
                        <figure class="image"><a href="images/resource/news-3.jpg" class="lightbox-image"  data-fancybox="images" data-caption=""><img src="images/resource/instagram-3.jpg" alt=""></a></figure>
                        <figure class="image"><a href="images/resource/news-4.jpg" class="lightbox-image"  data-fancybox="images" data-caption=""><img src="images/resource/instagram-4.jpg" alt=""></a></figure>
                        <figure class="image"><a href="images/resource/news-1.jpg" class="lightbox-image"  data-fancybox="images" data-caption=""><img src="images/resource/instagram-5.jpg" alt=""></a></figure>
                        <figure class="image"><a href="images/resource/news-2.jpg" class="lightbox-image"  data-fancybox="images" data-caption=""><img src="images/resource/instagram-6.jpg" alt=""></a></figure>
                        <figure class="image"><a href="images/resource/news-3.jpg" class="lightbox-image"  data-fancybox="images" data-caption=""><img src="images/resource/instagram-7.jpg" alt=""></a></figure>
                        <figure class="image"><a href="images/resource/news-4.jpg" class="lightbox-image"  data-fancybox="images" data-caption=""><img src="images/resource/instagram-8.jpg" alt=""></a></figure>
                      </div>
                    </div>
